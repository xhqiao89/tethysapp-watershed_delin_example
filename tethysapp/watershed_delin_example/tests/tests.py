...
# from ..app import WatershedDelinExample
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_delin_example"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_delin_example.tests.tests"

        To run tests in the WatershedDelinExampleTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_delin_example.tests.tests.WatershedDelinExampleTestCase"

        To run only the test_if_tethys_platform_is_great function in the WatershedDelinExampleTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_delin_example.tests.tests.WatershedDelinExampleTestCase.test_if_tethys_platform_is_great"
...
class WatershedDelinExampleTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(WatershedDelinExample)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(WatershedDelinExample)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/watershed-delin-example/')  # The final '/' is essential for all pages/controllers
